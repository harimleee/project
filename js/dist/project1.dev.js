...
window.addEventListener('DOMContentLoaded', function () {
  ...
  $(window).on('scroll', function () {
    ...
    if (wheelDelta() == 'up') {
      $('h1').css('color', 'rgba(0,166,199,1)').css('transform', 'translate(0,0)');
    ...
    if ($(this).scrollTop() > $('h1').offset().top) {
      $('h1').css('color', 'rgba(0,166,199,0)').css('transform', 'translate(0,70%)');
  ...
  if (mql.matches) {
    ...
    $(window).on('scroll', function () {
      if ($(this).scrollTop() > $('h1').offset().top) {
        $('h1').css('color', 'rgba(0,166,199,0)').css('transform', 'translate(0,70%)');
        $('.main > img').css('width', '38%').css('transition', '1s');
        $('.main > p').css('transform', 'translate(0,0)').css('transition', '2s').css('opacity', '1');
      } else {
        $('h1').css('color', 'rgba(0,166,199,1)').css('transform', 'translate(0,0%)');
        $('.main > img').css('width', '48%').css('transition', '1s');
        $('.main > p').css('transform', 'translate(0,100%)').css('transition', '1s').css('opacity', '0');
      }
